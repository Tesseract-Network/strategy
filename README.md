...
- Ideas I believe the most in:
  ...
  - Combine the first two ideas: you can do both! I suggest starting from the first because it's easier to implement.
...
- Tesseract: all domains taken, used in the wild for whatever
